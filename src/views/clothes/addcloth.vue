        ...
        <el-form class="form-container" :model="postForm" :rules="rules" ref="postForm">
            ...
            <div style="margin:20px 0px;">
                <el-form-item label="最低温度:" style="margin-bottom: 40px;" label-width="90px" prop="minTemperature">
                    <el-input v-model="postForm.minTemperature" size="small" placeholder="最低温度" style="width:100px;"></el-input>
                </el-form-item>
                <el-form-item label="最高温度:" style="margin-bottom: 40px;" label-width="90px" prop="maxTemperature">
                    <el-input v-model="postForm.maxTemperature" size="small" placeholder="最高温度" style="width:100px;"></el-input>
                </el-form-item>
