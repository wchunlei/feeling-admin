    ...
    <el-form class="form-container" :model="postForm" :rules="rules" ref="postForm">
      ...
      <div class="createPost-main-container">
            ...
            <div class="postInfo-container">
              <el-row>
                <el-col :span="8">
                    ...
                    <el-form-item label-width="80px" label="交互文字:" class="postInfo-container-item">
                      <el-input placeholder="" style='min-width:150px;' v-model="postForm.question">
                      </el-input>
                    </el-form-item>
                ...
                <el-col :span="8">
                    ...
                    <el-form-item label-width="80px" label="接听:" class="postInfo-container-item">
                      <el-input placeholder="" style='min-width:150px;' v-model="postForm.allow">
                      </el-input>
                    </el-form-item>
                ...
                <el-col :span="8">
                    ...
                    <el-form-item label-width="80px" label="取消:" class="postInfo-container-item">
                      <el-input placeholder="" style='min-width:150px;' v-model="postForm.deny">
                      </el-input>
                    </el-form-item>
        ...
        <div style="margin-bottom: 20px;">
          <Upload v-model="postForm.audio_uri"></Upload>
        </div>
      ...
      submitForm() {
        ...
        this.$refs.postForm.validate(valid => {
          if (valid) {
            ...
            telUpdate(actorinfo).then(response => {
