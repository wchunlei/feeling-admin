            ...
            <div class="postInfo-container">
              <el-row>
                ...
                <el-col :span="8">
                    ...
                    <el-form-item label-width="80px" label="回答1:" class="postInfo-container-item">
                      <el-input placeholder="" style='min-width:150px;' v-model="postForm.answer1">
                      </el-input>
                    </el-form-item>
                ...
                <el-col :span="8">
                    ...
                    <el-form-item label-width="80px" label="回答2:" class="postInfo-container-item">
                      <el-input placeholder="" style='min-width:150px;' v-model="postForm.answer2">
                      </el-input>
                    </el-form-item>
