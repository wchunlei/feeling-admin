<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fithighlight-current-row style="width: 100%" max-height="500">
            ...
            <el-table-column min-width="150px" align="center" label="下架时间" prop="configdowntime" sortable>
                <template scope="scope">
            ...
            getList() {
                ...
                bannerlist(this.listQuery).then(response => {
                    ...
                    for (let i=0; i< response.data.content.length; i++) {
                        ...
                        if (response.data.content[i].configtime == '0000-00-00 00:00:00') {
                            this.list[i].configtime = "未设置";
                        }
                        if (response.data.content[i].configdowntime == '0000-00-00 00:00:00') {
