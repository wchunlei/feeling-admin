<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border highlight-current-row="true" style="width: 100%;" height="500">
            ...
            <el-table-column class-name="status-col" label="剧情价格（金币）" width="150px" prop="price">
                <template scope="scope">
                    <span>{{scope.row.price}}</span>
                </template>
            </el-table-column>

            <el-table-column min-width="150px" align="center" label="选项价格（金币）" prop="option">
                <template scope="scope">
