        ...
        <el-form v-show="infoForm" class="form-container" :model="postForm" ref="postForm" :rules="actorDetail">
            ...
            <div class="createPost-main-container">
                ...
                <el-form-item label="标题:" label-width="100px" prop="title" style="margin-bottom: 40px" required>
                    <el-input type="text" placeholder="最多输入15个字" style='width:200px;' v-model="postForm.title"  :maxlength="15" :rows="1"></el-input>
                </el-form-item>
...
<script type="text/ECMAScript-6">
    ...
    import { addhomefm } from 'api/homefm';
    ...
    export default {
        ...
        methods: {
            ...
            getDetail () {
                homefminfo (this.listQuery).then(response => {
            ...
            addFM (formName) {
                ...
                if (this.$route.params.id && this.$route.params.id == ':id') {
                    ...
                    updatehomefm(fminfo).then(response => {
                        if(response.data.code == 200) {
                            this.$message({
                                message: '发布成功',
                                type: 'success'
