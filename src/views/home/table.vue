<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fithighlight-current-row style="width: 100%" max-height="500">
            ...
            <!--<el-table-column class-name="status-col" label="剧情价格（金）" width="150px" prop="storyPrice">
                <template scope="scope">
                    <span>{{scope.row.storyPrice}}</span>
                </template>
            </el-table-column>

            <el-table-column min-width="150px" align="center" label="选项价格（金）" prop="optionPrice">
                <template scope="scope">
            ...
            <el-table-column min-width="150px" align="center" label="上架时间" prop="configtime" sortable>
                <template scope="scope">
            ...
            <el-table-column min-width="150px" align="center" label="排序" prop="roomsort">
                <template scope="scope">
                    ...
                    <!--<span class="link-type" @click='handleFetchPv(scope.row.pageviews)'>{{scope.row.pageviews}}</span>-->
                    <el-select v-model="scope.row.roomsort" placeholder="请选择" :disabled="disable" @visible-change="changeSort(scope.row)">
